...
def makeTerracotta(color,dyeNum,terracottaNum):
    ...
    recp["minecraft:recipe_shaped"]["description"]["identifier"]="minecraft:{}_terracotta_from_dye{}".format(color,dyeNum)
    recp["minecraft:recipe_shaped"]["tags"]=[ "crafting_table" ]
    recp["minecraft:recipe_shaped"]["group"]="stained_hardened_clay"
    recp["minecraft:recipe_shaped"]["priority"]=Priority
    recp["minecraft:recipe_shaped"]["pattern"]=["###","#X#","###"]
    recp["minecraft:recipe_shaped"]["key"]={}
    recp["minecraft:recipe_shaped"]["key"]["#"]={}
    recp["minecraft:recipe_shaped"]["key"]["#"]["item"]="minecraft:stained_hardened_clay"
    ...
    recp["minecraft:recipe_shaped"]["result"]["item"]="minecraft:stained_hardened_clay"
    recp["minecraft:recipe_shaped"]["result"]["data"]=terracottaNum
    recp["minecraft:recipe_shaped"]["result"]["count"]=8
    with open("{}_terracotta_from_dye{}.json".format(color,dyeNum),"w+") as json_file:
