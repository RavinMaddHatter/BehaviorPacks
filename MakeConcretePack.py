...
def makeTerracotta(color,dyeNum,terracottaNum):
    ...
    recp["minecraft:recipe_shaped"]["description"]["identifier"]="minecraft:{}_concrete_powder_from_dye{}".format(color,dyeNum)
    ...
    recp["minecraft:recipe_shaped"]["key"]["#"]={}
    recp["minecraft:recipe_shaped"]["key"]["#"]["item"]="minecraft:concrete_powder"
    ...
    recp["minecraft:recipe_shaped"]["result"]["item"]="minecraft:concrete_powder"
    recp["minecraft:recipe_shaped"]["result"]["data"]=terracottaNum
    recp["minecraft:recipe_shaped"]["result"]["count"]=8
    with open("{}_concrete_powder_from_dye{}.json".format(color,dyeNum),"w+") as json_file:
